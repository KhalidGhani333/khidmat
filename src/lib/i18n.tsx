...
const dict: Record<string, { en: string; ar: string }> = {
  ...
  "testi.ahmed.quote": { en: "Our marble floors look brand new. Khidmat's team was punctual, professional and the result exceeded our expectations. The shine has lasted for over a year.", ar: "تبدو أرضيات الرخام لدينا كأنها جديدة. كان فريق خدمة منضبطاً ومحترفاً والنتيجة تجاوزت توقعاتنا. استمر اللمعان لأكثر من عام." },
  "testi.sara.name": { en: "Sara Al-Mutairi", ar: "سارة المطيري" },
  "testi.sara.role": { en: "Interior Designer, Riyadh", ar: "مصممة ديكور، الرياض" },
  "testi.sara.quote": { en: "I recommend Khidmat to every one of my clients. Their attention to detail, the diamond polishing technique and the final finish quality is genuinely in another league.", ar: "أوصي بخدمة لكل عملائي. اهتمامهم بالتفاصيل وتقنية التلميع بالألماس وجودة التشطيب النهائي في مستوى آخر تماماً." },
