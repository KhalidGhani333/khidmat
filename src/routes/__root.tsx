...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Professional marble, tile and granite polishing services in Riyadh. Premium Italian equipment, 25+ years of experience." },
      ...
      { property: "og:site_name", content: "Barwiz Marble & Tile Care" },
