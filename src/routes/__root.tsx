...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Restore the brilliance of your floors with Riyadh's #1 marble specialists." },
...
{ rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700;900&family=Inter:wght@400;600;700&family=Cairo:wght@400;700;900&family=Roboto:wght@400;500;700;900&display=swap" },
    ],
  }),
